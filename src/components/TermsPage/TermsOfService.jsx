    ...
    <TextContainer>
      <article id="0b15798f-eed5-48ae-9cda-292dfc9e4ea5" className="page sans">
        ...
        <div className="page-body">
          ...
          <H1 id="84e86c22-847d-4363-a267-b7bc881129f5">AGREEMENT TO TERMS</H1>
          <Paragraph id="9d7937f4-459d-421a-86fa-f7b8feeafbbe">
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and future modern builderberg, LLC (&quot;Company&quot;, “we”, “us”,
            or “our”), concerning your access to and use of the
            futuremodern.netlify.app website as well as any other media form,
            ...
            registered in New Mexico, United States and have our registered
            office at 530-B Harkle Road, STE 100, Santa Fe, NM 87505. You agree
          ...
          <Paragraph id="7db998f6-0705-4bfa-bff3-c49fcff8c923">
            ...
            local laws, if and to the extent local laws are applicable. The Site
            is not tailored to comply with industry-specific regulations (Health
          ...
          <Paragraph id="251d6110-f190-4647-a70a-9c98fd22fa12">
          ...
          <H1 id="227b51f9-9625-4154-91b5-2f255222cd93">
            INTELLECTUAL PROPERTY RIGHTS
          </H1>
          <Paragraph id="55669ad3-38e3-4ad6-b4a5-eed4c6007d1c">
          ...
          <Paragraph id="82822881-8791-4c39-aa05-d53be0ae6af2">
            Provided that you are eligible to use the Site, you are granted a
            limited license to access and use the Site and to download or print
            a copy of any portion of the Content Compliance Checklist to which
          ...
          <H1 id="491f9a06-91d4-4aad-802f-d2b2ff537e3d">
            USER REPRESENTATIONS
          </H1>
          <Paragraph id="ffa9fd17-c085-4b16-ac9f-f4231252c9ae">
          ...
          <Paragraph id="639b75b5-11c3-4c4d-b545-751ef9ac3b31">
            If you provide any information that is untrue, inaccurate, not
            current, or incomplete, we have the right to suspend or terminate
            your account and refuse any and all current or future use of the
            Site (or any portion thereof).
          </Paragraph>
          <H1 id="0af1dfa5-a25b-4277-a964-404ddc56b971">PRODUCTS</H1>
          <Paragraph id="e1241008-72f0-45ea-b891-1db5811b46e2">
            All products are subject to availability. We reserve the right to
            discontinue any products at any time for any reason. Prices for all
            products are subject to change.
          </Paragraph>
          <H1 id="1674833b-6ffa-4bbb-b50b-b7efe2704422">
            PURCHASES AND PAYMENT
          </H1>
          <Paragraph id="b0effc97-b2b4-4278-8441-3fba0bae7e52">
            We accept the following forms of payment:
          </Paragraph>
          <UL
            id="4ca7d0b9-edf5-43e2-b4ae-172c89edf4c8"
          ...
          <Paragraph id="5e085721-ff8a-487d-b0e3-5f911364a1a2">
            ...
            U.S. dollars. You agree to pay all charges at the prices then in
          ...
          <Paragraph id="3e760c5c-7cb1-45e6-9c2c-0e6fb9450dcc">
          ...
          <H1 id="f865811b-802d-4f48-80a4-dc079c5f7d42">REFUNDS POLICY</H1>
          <Paragraph id="2b1cc470-0a4e-4b56-8d8f-016f3d3b381c">
            All sales are final and no refund will be issued.
          </Paragraph>
          <H1 id="263c5f10-d223-4e88-aa89-5f80e0ca1933">
            PROHIBITED ACTIVITIES
          </H1>
          <Paragraph id="ff5caff1-ec12-4c9b-9c64-607ae2ec6122">
          ...
          <OL
            type="1"
            id="bf0965f0-664a-490d-a243-47c3f936912c"
          ...
          <Divider />
          <H1 id="17fcdec2-a445-4eb3-917e-0ab34878ef3e">
            USER GENERATED CONTRIBUTIONS
          </H1>
          <Paragraph id="476314a4-90f2-4daf-a946-04a1058eb8a7">
          ...
          <OL
            type="1"
            id="3698e37d-3deb-4d7c-87f0-d130929974bf"
            className="numbered-list"
            start="1"
          >
            <LI>
          ...
          <OL
            type="1"
            id="711091b5-5280-4197-9e36-d166f98aa71a"
            className="numbered-list"
            start="2"
          >
            <LI>
          ...
          <OL
            type="1"
            id="c53ceef4-d2db-4b4c-83de-bef0052d8b8b"
            className="numbered-list"
            start="3"
          >
            <LI>
          ...
          <OL
            type="1"
            id="9dbc8f06-8ca2-4165-8d75-9d80ab913f8f"
            className="numbered-list"
            start="4"
          >
            <LI>
          ...
          <OL
            type="1"
            id="0520f65b-8dcc-43b0-9a54-6133fe5e9b35"
            className="numbered-list"
            start="5"
          >
            <LI>
          ...
          <OL
            type="1"
            id="a00175ce-e77b-471d-9dd3-9dea505b5dc4"
            className="numbered-list"
            start="6"
          >
            <LI>
          ...
          <OL
            type="1"
            id="107cf2f2-558a-4759-b40c-64cfe9ff2aab"
            className="numbered-list"
            start="7"
          >
            <LI>
          ...
          <OL
            type="1"
            id="ddb888cf-d3c7-47de-b156-7e5b1ca86c73"
            className="numbered-list"
            start="8"
          >
            <LI>
          ...
          <OL
            type="1"
            id="ba717fa3-9579-496b-8648-b78b53b43264"
            className="numbered-list"
            start="9"
          >
            <LI>
          ...
          <OL
            type="1"
            id="febf9c29-7fd5-4f57-ab53-a6cd139daf81"
            className="numbered-list"
            start="10"
          >
            <LI>
          ...
          <OL
            type="1"
            id="e9c5ec9b-1028-4406-b367-61d809229b29"
            className="numbered-list"
            start="11"
          >
            <LI>
          ...
          <OL
            type="1"
            id="f02bbc48-7d22-44fa-bbb2-90898b22c855"
            className="numbered-list"
            start="12"
          >
            <LI>
          ...
          <OL
            type="1"
            id="f4ceb692-7b78-424e-8f53-7cce888b966c"
            className="numbered-list"
            start="13"
          >
            <LI>
              ...
              applicable law or regulation. Any use of the Site or the
              Marketplace Offerings in violation of the foregoing violates these
              Terms of Use and may result in, among other things, termination or
              suspension of your rights to use the Site and the Marketplace
              Offerings. CONTRIBUTION LICENSE You and Site agree that we may
              access, store, process, and use any information and personal data
              that you provide following the terms of the Privacy Policy and
              your choices (including settings). By submitting suggestions or
              other feedback regarding the Site, you agree that we can use and
          ...
          <Divider />
          <H1 id="fcbf54b6-65be-4ab7-8e87-923745252eb5">SUBMISSIONS</H1>
          <Paragraph id="d10aa22d-98c6-4a60-870d-b8a22901ca72">
            You acknowledge and agree that any questions, comments, suggestions,
            ideas, feedback, or other information regarding the Site or the
            Marketplace Offerings (&quot;Submissions&quot;) provided by you to
            us are non-confidential and shall become our sole property. We shall
            own exclusive rights, including all intellectual property rights,
          ...
          <H1 id="7629a33c-6815-450c-adfb-207f11b1dce7">
            THIRD-PARTY WEBSITES AND CONTENT
          </H1>
          <Paragraph id="d1a30fc0-d7ff-4bbd-ab01-0524a08f0de1">
          ...
          <H1 id="f642d681-b1e9-4aa1-9889-a6ae93cf3269">SITE MANAGEMENT</H1>
          <Paragraph id="26fb36c6-3c75-4339-9dcb-a3d8636ff14a">
          ...
          <H1 id="c2896d88-b05b-411e-a6d7-3d876239b0ad">PRIVACY POLICY</H1>
          <Paragraph id="324e723e-2ddb-4be9-bf44-72a919fa0edd">
            ...
            Please be advised the Site and the Marketplace Offerings are hosted
          ...
          <H1 id="3c8ff90d-a7f5-4023-bf22-cca66d614e1b">
            TERM AND TERMINATION
          </H1>
          <Paragraph id="abc6ca3e-40fc-400b-bec3-7510dac9ca44">
          ...
          <Paragraph id="ce8d0dcb-131d-4df0-ab9b-2bcf9fd34d4d">
          ...
          <H1 id="3695a7b7-063d-4bd3-8062-a13362bfe443">
            MODIFICATIONS AND INTERRUPTIONS
          </H1>
          <Paragraph id="5c38cfa2-ee2b-452d-880f-875a0b76ca02">
            ...
            Site or the Marketplace Offerings. We cannot guarantee the Site and
            the Marketplace Offerings will be available at all times. We may
            ...
            Offerings at any time or for any reason without notice to you. You
            ...
            the Marketplace Offerings during any downtime or discontinuance of
            the Site or the Marketplace Offerings. Nothing in these Terms of Use
          ...
          <H1 id="290a9d69-c304-4053-94de-60c6f06f0954">GOVERNING LAW</H1>
          <Paragraph id="7756ba9a-2128-40ab-908b-44ca9dccae38">
          ...
          <H1 id="b4e46b89-2383-4666-9f8a-e639b12c426a">DISPUTE RESOLUTION</H1>
          <H2 id="e2bfb7f1-3389-4180-a3e1-e0eae937591a">
            Informal Negotiations
          </H2>
          <Paragraph id="b22fd16e-8c63-4ba7-b0bf-7471fd9739ad">
          ...
          <H2 id="09908470-0e16-4946-aa43-0932743d3713">Binding Arbitration</H2>
          <Paragraph id="3802423d-54f3-4793-8baf-8107454e5e43">
          ...
          <Paragraph id="5e19841b-c808-4cc4-8ce1-4dad8fc71968">
            ...
            (UCITA) are excluded from these Terms of Use. If this provision is
          ...
          <H2 id="e73b53d5-c562-4bdd-8482-9668090d27bd">Restrictions</H2>
          <Paragraph id="c8941a31-3aea-4275-b9a1-a98ad00f853b">
          ...
          <H2 id="f9fd69ee-b162-46f2-a6df-98aa2169762a">
            Exceptions to Informal Negotiations and Arbitration
          </H2>
          <Paragraph id="d75ee75a-03cc-4227-8b28-f32617f94da1">
          ...
          <H1 id="a4583248-75ff-49d4-a107-db263f0bcddb">CORRECTIONS</H1>
          <Paragraph id="beae92ac-a07a-4805-b03d-41bb5e2b79eb">
          ...
          <H1 id="d837a02b-7045-4ab2-9121-4be9f10fb6be">DISCLAIMER</H1>
          <Paragraph id="30fa2acc-b7b2-41ee-a593-5186cd5f8162">
          ...
          <H1 id="3f3c5bab-2388-48e8-96f6-f36785c3f4e9">
            LIMITATIONS OF LIABILITY
          </H1>
          <Paragraph id="24f0174e-cd03-47dd-ab89-dd40a4ba073c">
          ...
          <H1 id="f1bdfd3c-c04d-4824-9ab2-5fa13895d62d">INDEMNIFICATION</H1>
          <Paragraph id="97bc4620-a604-481e-85ab-bee0833606c6">
          ...
          <H1 id="17a867e1-93b3-4fab-a9a7-5bc8a84d7168">USER DATA</H1>
          <Paragraph id="08e8eaa0-8a64-40ce-8f41-ac252b8b6f75">
          ...
          <H1 id="f6da54a7-25bf-4907-a814-cdd6ac14c573">
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </H1>
          <Paragraph id="f4ada354-4d8f-4687-8992-2f6ce8fffc23">
          ...
          <H1 id="a2a933bf-122b-4505-b635-250f3a055ad0">
            CALIFORNIA USERS AND RESIDENTS
          </H1>
          <Paragraph id="16c72095-33fa-48db-94eb-12bc17aecd0a">
          ...
          <H1 id="d137fb13-2e55-41c7-9dd5-8bd982674c80">MISCELLANEOUS</H1>
          <Paragraph id="ba07aacd-625d-438e-bbf6-e3284b324d28">
          ...
          <H1 id="7ac7285e-6fd7-4884-9cc7-e4b657f13515">CONTACT US</H1>
          <Paragraph id="c040d681-6f60-4582-b49b-8f75392de7bc">
            In order to resolve a complaint regarding the Site or to receive
            further information regarding use of the Site, please contact us at:
          </Paragraph>
          <Paragraph id="3f54917e-3e73-4a35-9517-00acbffe2bc7">
            future modern builderberg, LLC 530-B Harkle Road STE 100 Santa Fe,
            NM 87505 United States <br />
            Phone: +19092476376
            <br /> Email:
