...
const members = [
  ...
  // { name: "Aliza Makhani", img: aliza, title: "", socials:alizaSocials , cardColor: "#AFA5CA" },
  ...
  // { name: "Anson Goode Jr", img: anson, title: "", socials:ansonSocials , cardColor: "#76BE8D" },
  // { name: "Manny", img: manny, title: "", socials:mannySocials , cardColor: "#02734A" },
  // { name: "Big Baby Ghandi", img: ghandi, title: "", socials:ghandiSocials , cardColor: "#5574F5" },
  // { name: "Meltinginlava", img: lava, title: "", socials:lavaSocials , cardColor: "#2BA6D8" },
];
